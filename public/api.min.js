...
// 創建一個物件模組，就不用 window 的全域變數了
module.exports = {
  en: __webpack_require__(959),
  zh: __webpack_require__(454)
};
...
const i18n = __webpack_require__(939);
...
"use strict";
module.exports = JSON.parse('{"title":"Streams In English"}');
...
const getLang = __webpack_require__(830);
// 要打包套件的話就把套件用 npm 下載引用
const axios = __webpack_require__(669);
const contentObj = __webpack_require__(181);
